	...
	<div class="bottomBack">
        ...
        <div class="mainPart">
            ...
            <div class="leftColumn">
                ...
                <div class="userTab">
                	<a href="uInfor.jsp" target="mainFrame"><div>个人信息</div></a>
            ...
            <div class="mainColumn">
            	...
            	<iframe src="uInfor.jsp?value=<%=request.getAttribute("info")%>" scrolling="auto" name="mainFrame" class="inforFrame"  allowTransparency="true">
