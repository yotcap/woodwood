...
<body>
	<div class="content">
    	<form name="basicForm" action="../../UserServlet?action=uInforStudent"method="post">
        	<div class="titleBasic"><span>基本信息</span></div>
            <div class="uName mainIn">姓名：<input type="text" name="uName" /></div>
            <div class="uMale mainIn">性别：<input type="text" name="uMale" /></div>
            <div class="both"></div>
