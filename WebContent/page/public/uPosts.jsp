	...
	<div class="content">
        ...
        <%
			...
			<div  style="background:#CCC;
						width:800px;	height:200px;	margin-top:1px; margin-bottom:3px;">
			...
			width:800px;height:112px;border-bottom:#999 solid 4px;"><!--帖子 -->
                	<%=book.getContent()%>
                </div>
                <div  style="float:left;
			width:800px;height:40px;padding-top:7px;color:#888;"><!--信息 -->
